...
})({"u59Yo":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "8f5214768cc6c477";
"use strict";
...
document.getElementById("getData").addEventListener("click", function() {
    _bleuio.ati().then((data)=>console.log(data));
});
document.getElementById("getData").addEventListener("click", function() {
    _bleuio.at_central();
});
document.getElementById("getData").addEventListener("click", function() {
    _bleuio.stop(()=>{
        _bleuio.at_gapscan(2).then((x)=>{
            console.log(x);
            var unique = [];
            var uniqDev = [];
            x.map((val)=>{
                if (val[0] === "[") {
                    if (unique.indexOf(val.slice(0, 4)) === -1) {
...
//   var pm1=parseInt('0x'+data.substr(pos+34,4).match(/../g).reverse().join(''))
//   console.log(pm1)
//   if(pm1>10)
//       pm1 = (pm1)/10
//   else
...
var pmvals;
const repeatfunc = ()=>{
    _bleuio.at_findscandata("01D2F5", 7).then((x)=>{
...
},{}]},["u59Yo","ibl44"], "ibl44", "parcelRequire94c2")

//# sourceMappingURL=index.8cc6c477.js.map
